...
function uleak_results_page() {
	...
	<div style="width: 51%; float: right;">
		...
		<p>This feature will check <b>Administrator</b> passwords against our leaked password repository. Our database is created on a regular basis and consists only of already cracked passwords that have been derived from public password-leaks and years of experience from working with hashcat. Furthermore we actively scan for new password leaks to include those to our collection. Current listed passwords: <b>194.459.270</b>.<br />All password request will be saved and listed in your ULeak monitoring <a href="https://www.uleak.de/pricing" target="_blank">dashboard</a>.</p>
